...
const newMessagesAfterReturn = [
  { text: "Le rouge en plus ajoute un aspect sanguin, qui fait peur et qui peut aussi faire allusion aux victimes qui souffrent. Parfait !", sender: "other", firstOther: true, delay: 3000 },
  { text: "C’est toi qui a choisi ces couleurs?", sender: "mine", firstMine: true, delay: 1000 },
  { text: "Oui, je me suis servi de Color Hunt. C’est un site qui répertorie des palettes. J’ai parcouru le site et je m’en suis inspiré pour créer ces 3 palettes.", sender: "other", firstOther: true, delay: 4000 },
  { text: "J'hésitais un peu entre les trois palettes.... Mais là ! Je suis sûr de partir sur celle avec le rouge et noir. Merci 👍", sender: "other", delay: 3000 },
  { text: "Y a pas de quoi 😉", sender: "mine", firstMine: true, delay: 1000 },
  { text: "De ce que j’ai vu, t'as donc déjà commencé à faire le design du site?", sender: "mine", delay: 2000 },
  { text: "Oui, j’ai commencé la maquette. Bon ce n’est pas un site niveau professionnel parce que j’ai découvert tout ca cette année en Création Numérique, mais je suis assez fier de ce début de maquette.", sender: "other", firstOther: true, delay: 5000 },
  ...
  { text: "Mais c’est incroyable! Donc on peut apprendre à faire ça dès la première année?", sender: "mine",firstMine: true, delay: 5000 },
  ...
  { text: "D’abord, on commence par une arborescence = un parcours de ton site. Ça ressemble à ça :", sender: "other", note: "Arborescence = Comment est organisé un site web. Un peu comme un plan qui montre les différentes pages et comment on passe de l'une à l'autre.", delay: 6000 },
  {text: "<img src='../../img.video/arbo.png' alt='Schéma qui explique une Arborescence' />", sender: "other", delay: 100 },
  { text: "Donc c’est une liste de toutes les pages du site",firstMine: true, sender: "mine", delay: 9000 },
  { text: "A peu près. Il faut aussi prendre en compte la navigation (quelle page mène vers quelle page. Un exemple simple : tu ne peux accéder à la page d’un produit qu’après être allé sur la page catalogue d’un site en ligne)", sender: "other", firstOther: true, delay: 5000 },
  ...
  { text: "Ca permet de voir comment seront structurées les pages du site web. C’est très schématique, on n’utilise ni les couleurs ni les typographies de la campagne.", sender: "other", note: "Wireframe = Un brouillon de site web. C'est pour montrer où on met les choses (comme les boutons, les images), mais sans déco : pas de couleurs ni de jolis textes.", delay: 12000 },
  {text: "<img src='../../img.video/wireframe.png' alt='Schéma qui explique une Wireframe' />", sender: "other", delay: 100 },
  { text: "C'est une maquette, mais sans style",firstMine: true, sender: "mine", delay: 4000 },
  { text: "Exactement! Enfin, tu fais ta maquette. Tu reprends tes wireframes mais tu remplaces le contenu schématique par les vrais contenues : les vraies photos, les vraies couleurs, les vraies typographies…", sender: "other", firstOther: true, note: "Maquette = Le design final du site, mais juste en image. Ça montre à quoi le site va vraiment ressembler avant de le créer pour de vrai.", delay: 7000 },
  { text: "Une fois la maquette faite, Ayoub pourra développer le site en entier.", sender: "other", delay: 1500 },
  { text: "Tu as utilisé quel outil pour ta maquette ?",firstMine: true, sender: "mine", delay: 1000 },
  { text: "Figma! Je te le recommande vivement. En plus, c’est gratuit.", firstOther: true, sender: "other", note: "Pour construire une maquette = Figma (Gratuit)", delay: 5000 },
  { text: "C'est cool ça ! Je peux commencer dès maintenant à m'entraîner",firstMine: true, sender: "mine", delay: 1000 },
  { text: "C’est le bon état d’esprit à avoir! Sur ce, je te laisse je vais aller dormir.", sender: "other", firstOther: true, delay: 1000 },
  { text: "D'ailleurs, Nicolas m’a dit qu’il comptait te contacter dans la soirée", sender: "other", delay: 1500 },
...
const conversation = [
  { text: "Salut, c’est Erwan, on passe à la créa ?", sender: "other", firstOther: true, delay: 1500 },
  { text: "Ok, je te suis ! On va faire quoi ?", sender: "mine", firstMine: true, delay: 1500 },
  { text: "Je vais commencer par l’identité visuelle de la campagne.", sender: "other", firstOther: true, delay: 2000 },
  { text: "La communication visuelle, c’est super important !", sender: "other", delay: 2000 },
  { text: "Par exemple, si tu vas à Carrefour et que tu as deux bouteilles d’eau au même prix.", sender: "other", delay: 2000 },
  { text: "Comment est ce que tu vas faire ton choix ?", sender: "other", delay: 3000 },
  { text: "Je vais choisir celle qui me plaît le plus visuellement, non ?", sender: "mine", firstMine: true, delay: 2000 },
  { text: "Exactement, c’est pourquoi c’est très important d’avoir une identité visuelle impactante qui donne l’ambiance de notre campagne.", sender: "other", firstOther: true, note: "Identité Visuelle = Ce qui fait qu'on reconnaît une marque, comme son look, grâce à ses couleurs et ses formes.", delay: 3000 },
  { text: "En parlant d’harcèlement et en ciblant l’harceleur, on doit donner une ambiance inquiétante, une ambiance d’alerte…", sender: "other", delay: 5000 },
  ...
  { text: "C’est un document qui contient le logo, les couleurs de la campagne, les typographies…", sender: "other", note: "Charte Graphique = Un guide avec toutes les infos sur le style d'une marque, y compris le logo, les couleurs utilisées, les types de typographies...", delay: 7000 },
  { text: "D’ailleurs, ça te dit de m’aider ? J’hésite entre 3 palettes de couleurs. Selon toi, laquelle colle le mieux à notre campagne ?", sender: "other", delay: 2000 },
...
function addMessagesSequentially(messages, index, returnAfterLastMessage = false) {
  ...
  case 2: // Palette C
    newMessages = [
      ...
      { text: "Le noir me paraît correct pour représenter la gravité de notre ton, j'aime bien.", sender: "other", firstOther: true, delay: 3000 }
    ]; 
    addMessagesSequentially(newMessages, 0);
